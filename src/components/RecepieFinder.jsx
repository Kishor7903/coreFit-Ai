...
import useRecepieInfo from '../hooks/useRecepieInfo'
import { useEffect } from 'react';

function RecepieFinder() {
    ...
    const fetchResult = async (file) => {
      try {
        const result = await useRecepieInfo(file);
        ...
        <div className="w-[60rem] h-[25rem] border-2 border-white">
          ...
          <div className="w-[50%]">
            ...
            <div className="flex justify-between">
              ...
              Upload the image of the food to get the recepie of the food.
            </p>
